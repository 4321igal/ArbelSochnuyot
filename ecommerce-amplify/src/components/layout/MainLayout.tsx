        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="flex items-center space-x-6">
              {/* ניהול מוצרים - מוצג לכל משתמש מחובר; כניסה לדף מותנית בהרשאת Admin */}
              {isAuthenticated && (
                <Link
                  to="/admin/manager-product"
                  className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-indigo-600 bg-indigo-50 rounded-lg hover:bg-indigo-100"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
